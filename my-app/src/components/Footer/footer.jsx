...
const Footer = () => {
  return (
    <footer className="bg-linear-to-r from-[#2418A7] via-[#1F4CCB] to-[#1976D2] text-white mt-20">

      {/* Main Footer */}
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <h2 className="text-2xl font-bold">Digital Certification</h2>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <span className="text-gray-200">+91 9191919191</span>
            </div>
